      ...
      <div className="flex flex-col gap-6 rounded-xl bg-white px-5 py-6">
        ...
        <ul>
          {transactions.map((transaction, i) => (
            <li
              key={transaction._id}
              className={`flex items-center justify-between py-4 ${i !== transactions.length - 1 ? "border-b border-solid border-grey-100" : ""}`}
            >
              ...
              <div className="flex flex-col items-end gap-1">
                <span
                  className={`text-[0.875rem] font-bold leading-normal tracking-normal ${transaction.amount > 0 ? "text-green" : "text-grey-900"}`}
                >
